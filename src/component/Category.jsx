...
const Category = () => {
  ...
  return (
    ...
    pb-[80px] flex lg:flex-row flex-col justify-center items-center gap-20'>
      ...
      flex-col justify-center ig:items-start items-center gap-[20px]'>
        <h1 className='text-purple-600 text-xl font-semibold text-center'>Favorite item</h1>
        <h1 className='text-black font-semibold text-[42px] leading-[50px] lg:text-start text-center'>Popular Category</h1>
        <button className='bg-purple-600 hover:bg-red-600 text-white
      ...
      justify-center items-start gap-10'>
        ...
        justify-center items-center gap-6'>
          ...
          <img src={cat1} alt="" className='rounded-full curdor-pointer'/>
          <h1 className='text-black text-xl font-semibold hover:text-purple-600
        ...
        justify-center items-center gap-6'>
          ...
          <img src={cat2} alt="" className='rounded-full curdor-pointer'/>
          <h1 className='text-black text-xl font-semibold hover:text-purple-600
          cursor-pointer'>Portable Speakers</h1>
        ...
        justify-center items-center gap-6'>
          ...
          <img src={cat3} alt="" className='rounded-full curdor-pointer'/>
          <h1 className='text-black text-xl font-semibold hover:text-purple-600
          cursor-pointer'>Portable Speakers</h1>
        ...
        justify-center items-center gap-6'>
          ...
          <img src={cat4} alt="" className='rounded-full curdor-pointer'/>
          <h1 className='text-black text-xl font-semibold hover:text-purple-600
          cursor-pointer'>Portable Speakers</h1>
        ...
        justify-center items-center gap-6'>
          ...
          <img src={cat5} alt="" className='rounded-full curdor-pointer'/>
          <h1 className='text-black text-xl font-semibold hover:text-purple-600
          cursor-pointer'>Portable Speakers</h1>
